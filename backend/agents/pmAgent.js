...
* Ask only 6 important clarifying questions unless the product is complex. Never ask more than 6.
...
function buildUserPrompt(state) 
{
  ...
  return [
    ...
    `Conversation so far:\n${conversation}`,
    "Check if the user answered the PM questions clearly.",
    "If anything important is missing or unclear, ask only those missing questions.",
    "If the answers are clear enough, return status spec_ready with the final spec.",
  ].join("\n\n");
